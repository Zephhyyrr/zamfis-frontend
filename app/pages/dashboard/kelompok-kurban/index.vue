<template>
  <div>
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
      <div>
        <h1 class="text-2xl font-bold text-gray-800">Kelompok Kurban</h1>
        <p class="text-gray-600">Kelola kelompok peserta kurban bersama</p>
      </div>
    ...
    <div v-if="showUndoBanner"
      ...
      <p class="text-sm text-amber-800">Kelompok kurban dipindahkan ke draft. Pulihkan sekarang?</p>
      <button type="button"
