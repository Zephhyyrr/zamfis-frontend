<template>
  <div class="max-w-xl mx-auto">
    <div class="mb-6 flex items-center gap-4">
      ...
      <div>
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Tambah Kelompok Kurban</h1>
        <p class="text-gray-600 dark:text-gray-400">Tambahkan kelompok peserta kurban baru</p>
      </div>
    </div>
