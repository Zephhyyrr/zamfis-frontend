<template>
  <div>
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
      <div>
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Media Pembayaran</h1>
        <p class="text-gray-600 dark:text-gray-400">Kelola metode / media pembayaran yang tersedia</p>
      </div>
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          <thead class="bg-gray-50 dark:bg-gray-700/50">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Nama Media Pembayaran</th>
    ...
    <FeaturesMediaPembayaranDeletePermanentModal
