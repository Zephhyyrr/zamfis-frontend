<template>
  <section id="beranda" class="relative min-h-[92vh] flex items-center overflow-hidden">
    ...
    <div
      class="absolute top-0 right-0 w-[600px] h-[600px] bg-primary/20 rounded-full blur-[150px] -translate-y-1/3 translate-x-1/4">
    </div>
    <div class="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full blur-[120px] -translate-x-1/3 translate-y-1/4"
    ...
    <div class="relative z-10 container mx-auto px-4 md:px-12 py-20 text-center">
      ...
      <h2
        class="text-4xl sm:text-5xl md:text-7xl font-extrabold text-white mb-6 leading-tight tracking-tight drop-shadow-xl">
