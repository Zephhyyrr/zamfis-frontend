    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        <div class="mt-1 flex rounded-md shadow-sm">
          <input v-model="form.uraian" type="text" list="edit-favorite-uraian-list" autocomplete="off"
            class="flex-1 block w-full border border-gray-300 dark:border-gray-600 rounded-none rounded-l-md shadow-sm py-2 px-3 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400" />
      ...
      <div>
        ...
        <input :value="form.debitText" @input="handleDebitInput" type="text" inputmode="numeric"
          :disabled="form.tipe === 'uang_keluar'"
          class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 disabled:opacity-50 disabled:bg-gray-100 disabled:dark:bg-gray-800 disabled:cursor-not-allowed"
          placeholder="Rp. 0" />
      </div>
      <div>
