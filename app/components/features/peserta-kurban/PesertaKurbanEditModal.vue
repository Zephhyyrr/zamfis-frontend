<template>
  ...
  >
    <div class="space-y-4">
      <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Nama Peserta</label>
      ...
      <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Tipe Kurban</label>
      ...
      <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Nominal</label>
        <input :value="form.nominalText" @input="handleCurrencyInput" type="text" inputmode="numeric"
          placeholder="Rp. 0"
          class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400" />
      </div>
      <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Media Pembayaran</label>
      ...
      <div v-if="form.tipe === 'kelompok'">
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Kelompok Kurban</label>
        <select v-model.number="form.kelompokKurbanId" :disabled="!form.tahun"
          class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm disabled:opacity-50 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400">
